      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="space-y-8 text-muted-foreground">
          <section>
            ...
            <p>
              By accessing and using the Ikenna platform, you accept and agree to be bound by the terms and
          ...
          <section>
            ...
            <p>
              Ikenna grants you a limited, non-exclusive, non-transferable license to access and use the platform
          ...
          <section>
            ...
            <p>
              ...
              under your account or password. You must notify Ikenna immediately of any unauthorized uses of your
              account.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Your use of the platform is also governed by our Privacy Policy. Ikenna takes data security seriously and
              implements industry-standard security measures. However, no method of transmission over the internet is
              100% secure. By using Ikenna, you acknowledge and agree to this inherent risk.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Ikenna and its suppliers will not be liable for any damages (including, without limitation, damages for
              loss of data or profit, or due to business interruption) arising out of the use or inability to use the
              materials on Ikenna's platform, even if Ikenna or an authorized representative has been notified orally or
          ...
          <section>
            ...
            <p>
              The materials appearing on Ikenna's platform could include technical, typographical, or photographic
              errors. Ikenna does not warrant that any of the materials on its platform are accurate, complete, or
              current. Ikenna may make changes to the materials contained on its platform at any time without notice.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Ikenna has not reviewed all of the sites linked to its platform and is not responsible for the contents of
              any such linked site. The inclusion of any link does not imply endorsement by Ikenna of the site. Use of
          ...
          <section>
            ...
            <p>
              Ikenna may revise these terms of service for its platform at any time without notice. By using this
