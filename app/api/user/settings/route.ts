...
export async function PATCH(request: Request) {
  ...
  try {
    ...
    const { profile = {}, preferences = {}, notifications = {} } = body || {}
    ...
    const settingsUpdates: Record<string, string | boolean> = {}
    ...
    await createAuditLog({
      ...
      metadata: {
        ...
        preferences: Object.keys(settingsUpdates).filter((key) => key.includes("Notifications") === false),
