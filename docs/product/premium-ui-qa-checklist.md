...
| --- | --- | --- | --- | --- | --- | --- |
| Landing | 1440px | Premium hierarchy, spacing, CTA flow | Landing story + FAQ + tighter hero/header/footer copy | Needs live browser pass | Pending | Capture full-page view after redeploy |
...
| Admin / System | 1280px | Founder separation | Existing founder checks preserved | Needs live founder/org-owner retest | Pending | Record blocked/allowed views |
