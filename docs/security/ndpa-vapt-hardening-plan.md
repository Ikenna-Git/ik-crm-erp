...
- CI/security workflow setup is documented, but the workflow file is intentionally not included in this pushed branch because the current GitHub token lacks workflow scope. Deeper SAST/secret scanning is still missing.
